//START SETUP
var garageName = 'Garage Door 2';
var uuidTag = 'garage2';
var sensorPin = 12;
var pythonFile = 'garage2';
//END SETUP
...
var GARAGE_DOOR = {
  ...
  open: function() {
    ...
    cmd.run('sudo python /home/pi/HAP-NodeJS/python/'+pythonFile+'.py');
...
var garageUUID = uuid.generate('hap-nodejs:accessories:garage:'+uuidTag);
var garage = exports.accessory = new Accessory(garageName, garageUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
garage.username = "C2:4D:1F:AE:6E:4A"; //edit this if you use Core.js
...
garage
  .addService(Service.GarageDoorOpener, garageName)
...
garage
  ...
  .on('get', function(callback) {
    ...
    wpi.setup('phys');
    sensorReading = wpi.digitalRead(sensorPin);
