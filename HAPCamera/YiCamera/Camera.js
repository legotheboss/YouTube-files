...
var cameraAddress = '1.1.1.1' //replace the 1.1.1.1 with your YiCamera's address
...
Camera.prototype.handleSnapshotRequest = function(request, callback) {
  ...
  cmd.run('ffmpeg -i rtsp://'+ cameraAddress + ':554/ch0_0.h264 -ss 00:00:00.000 -f image2 -vframes 1 /home/pi/HAP-NodeJS/lib/res/snapshot.jpg -y');
